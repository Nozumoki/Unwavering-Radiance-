--Unrelenting Dreams - Ayumu
local s,id=GetID()
function s.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	Fusion.AddProcMix(c,true,true,aux.FilterBoolFunctionEx(Card.IsSetCard,0xF9F),aux.FilterBoolFunctionEx(Card.IsSetCard,0xF9F))
...
function s.filter1(c,e,tp)
	return c:IsFaceup() and c:IsSetCard(0xF9F) and c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEUP_DEFENSE)
