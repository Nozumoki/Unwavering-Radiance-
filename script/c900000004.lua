...
function s.initial_effect(c)
	...
	c:RegisterEffect(e1)
	--Destroy 1 of opponent's face-up cards
...
function s.spfilter(c,e,tp)
	return c:IsSetCard(0xF9F) and not c:IsCode(id) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
