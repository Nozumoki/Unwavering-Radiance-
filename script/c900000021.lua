...
function s.thfilter(c)
	return c:IsSetCard(0xF9F) and c:IsType(TYPE_MONSTER) and c:IsAbleToHand()
end
function s.thtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chkc then return chkc:IsLocation(LOCATION_) and chkc:IsControler(tp) and s.thfilter(chkc) end
